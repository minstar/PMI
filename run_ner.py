...
def main():
    ...
    model = NER.from_pretrained(
        ...
        config=config,
        cache_dir=model_args.cache_dir,
        random_bias=model_args.random_bias,
        freq_bias=model_args.freq_bias,
        pmi_bias=model_args.pmi_bias,
        mixin_bias=model_args.mixin_bias,
        penalty=model_args.penalty,
        lambda_val=model_args.lambda_val,
        length_adaptive=model_args.length_adaptive,
    )
    ...
    train_dataset = (
        NerDataset(
            ...
            class_alpha=data_args.class_alpha,
            word_alpha=data_args.word_alpha,
